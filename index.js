...
function forceHeadingLinebreaks(text) {
  ...
  var enLabels = [
    'Name of FSP:', 'FSP Registration Number:', 'Category:', 'Professional Indemnity Insurance:',
    'Name of FSP', 'Representative Details', 'Communication Method',
    'Client Identification', 'Know Your Client', 'Financial Intelligence Centre',
    'Protection of Personal Information', 'Claims History Declaration',
    'FAIS Compliance Disclosure',
    'Insurer and Policy Details', 'Fleet Composition', 'Goods in Transit Cover',
    'Motor Cover Sections', 'Named Driver Register', 'Vehicle Safety',
    'Agreed Value Principle', 'Alteration of Risk', 'Claims Notification',
    'Tracking Requirements', 'Conditions That May Result',
    'Liabilities and Extensions', 'Additional Products',
    'Risk Profile and Claims', 'Sub-Contractor Arrangements', 'Hazardous Goods',
    'Remuneration Transparency', 'Conflict of Interest Declaration',
    'Method of Acceptance', 'Key Discussion Points',
    'Documentation Provided', 'Client Instructions',
    'Advice Validity', 'Outstanding Items',
